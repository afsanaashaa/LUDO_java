...
public class DiceRoll extends Application {
    ...
    private Parent createConetent(){
        ...
        button1Player.setStyle("-fx-background-color: #00FFFF; -fx-background-radius: 50%; -fx-text-fill: black;");
        ...
        gameButton.setStyle("-fx-background-color: #FF0000; -fx-text-fill: black;");
...
//        bgImage.setFitWidth(600);
        Image img = new Image("file:D:\\LUDO_java\\projectBackground\\src\\main\\java\\org\\example\\snakebg.jpg");
        ImageView bgImage = new ImageView();
        bgImage.setImage(img);
        bgImage.setFitHeight(600);
        bgImage.setFitWidth(600);
